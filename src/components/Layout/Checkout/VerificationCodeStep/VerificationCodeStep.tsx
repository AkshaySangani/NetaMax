...
export const VerificationCodeStep = (props: IVerificationCodeStepProps): ReactElement => {
  ...
  /**
   * generate random number for dependency in useEffect
   * @returns {void}
   */
  const readField = () => {
    if (setVerificationCodeField) setVerificationCodeField(Math.random());
  };
  ...
  return (
    <>
      <Box display="flex" flexDirection="column" alignItems="center">
        ...
        <Center>
          <Text textAlign="center" paddingTop="12px" fontSize="17px">
            Ingresa el código de <b>4 dígitos</b> que envíamos a tu número de whatsapp{" "}
            <b>{userPhone}</b>
          </Text>
        </Center>
      </Box>
